...
@section('content')
    <div class="sidebar-group left-sidebar chat_sidebar">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 363px;">
            <div id="chats" class="left-sidebar-wrap sidebar active slimscroll"
                 style="overflow: hidden; width: 100%; height: 363px;">
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 363px;">
                    <div class="slimscroll" style="overflow: hidden; width: 100%; height: 363px;">
                        ...
                        <div class="top-online-contacts">
                            <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    ...
                                    <div class="swiper-slide" style="width: 71px; margin-right: 15px;">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
...
<span class="dot"></span>
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body">
                                        <div>
                                            ...
                                            <p><span class="material-icons">videocam</span> It seems logical that the
                                            </p>
                                        </div>
                                        <div class="last-chat-time">
                                            <small class="text-muted">Yesterday</small>
                    ...
                    <div class="slimScrollBar"
                         style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 128.305px;"></div>
                    <div class="slimScrollRail"
                         style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
                </div>
            </div>
            <div class="slimScrollBar"
                 style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 363px;"></div>
            <div class="slimScrollRail"
                 style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
        </div>
    ...
    <div class="chat" id="middle">
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 293px;">
            <div class="slimscroll" style="overflow: hidden; width: 100%; height: 363px;">
                <div class="chat-header">
                    ...
                    <div class="chat-options">
                        <ul class="list-inline">
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                            ...
                            <li class="list-inline-item dream_profile_menu" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" title="" data-bs-original-title="Profile">
            ...
            <div class="slimScrollBar"
                 style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 264px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 121.895px;"></div>
            <div class="slimScrollRail"
                 style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
        </div>
    ...
    <div class="right-sidebar right_sidebar_profile" id="middle1">
        <div class="right-sidebar-wrap active">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 533px;">
                <div class="slimscroll" style="overflow: hidden; width: 100%; height: 363px;">
                ...
                <div class="slimScrollBar"
                     style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 302.222px;"></div>
                <div class="slimScrollRail"
                     style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
            </div>
        </div>
